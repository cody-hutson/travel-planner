...
venue key and nothing else, and every marker here reads `venue: unminted` — the hub
mints the token at its first enumeration, which runs after this writer, and this
fixture runs no hub.
