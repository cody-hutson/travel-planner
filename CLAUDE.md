...
| Hub Planner | `agents/05-hub-planner.md` | `outputs/links-reference.md`, `outputs/venue-matrix.md`, `outputs/final-itinerary.md`, `outputs/satisfaction-metrics.md` | Full synthesis or itinerary restructuring |
| Validator | `agents/06-validator.md` | `outputs/validation-report.md`, `outputs/satisfaction-metrics.md` | After hub produces/updates itinerary |
