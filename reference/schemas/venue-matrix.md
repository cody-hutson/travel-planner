# Artifact schema — C11 `outputs/venue-matrix.md`

The venue/day placement matrix, rebuilt each synthesis. `bound`, and the enforcement surface for the two-appearance venue cap.
...
schema-version: 1
path-pattern: trips/*/outputs/venue-matrix.md
path-pattern: examples/*/outputs/venue-matrix.md
witness: examples/data-architecture-demo/outputs/venue-matrix.md
