# Artifact schema — C10 `outputs/links-reference.md`

The venue link reference, rebuilt by the hub each synthesis. `bound` — it reaches the published site.
...
schema-version: 1
path-pattern: trips/*/outputs/links-reference.md
path-pattern: examples/*/outputs/links-reference.md
no-witness-because: the only tracked instance is examples/tokyo-2026/outputs/links-reference.md, inside the worked example this release preserves unedited as its regression witness, so it cannot be versioned here
